...
/** GET /api/connections/settings — Get connection settings */
export const GET: RequestHandler = async ({ cookies, platform }) => {
	...
	try {
		const data = await apiRequest(ctx, '/v1/connections/settings');
		return json(data);
	} catch (e) {
...
/** PUT /api/connections/settings — Update connection settings */
